...
with open(file_to_save, "w") as txt_file:
    ...
    winning_county_summary = (
        f"-------------------------\n"
        f"The county with the most votes: {winning_c_candidate}\n"
        f"Winning county's vote count:{winning_county:,}\n"
        f"Winning county's percentage:{winning_c_percentage:.1f}%\n"
        f"-------------------------\n"
